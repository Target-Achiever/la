...
@section('content')
        <table cellspacing="0" cellpadding="0" class="force-full-width" style="border:1px solid #ddd;">
            <tr style="background-color: #fff;padding-bottom: 250px;">
                <td><img src="{{ URL::asset('images/Admin_Approval_icon.png')    }}" style="    padding-top: 50px;"
                         width="30%"></td>
            </tr>
            <tr>
                        ...
                        <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                            <tr>
                                <td style="text-align: center;"><h4>Hi <span style="color:#00d4ff;">{{ ucfirst($user[0]['name']) }}</span>,
                                        <br><br></h4>
                                    <p>We have verified your details and accompanying documents and are delighted to approve your account. Please login and update your service settings for your profile to become live to clients.</p>                                    <span
