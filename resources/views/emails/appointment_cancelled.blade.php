...
@section('content')
      ...
      <tr style="background-color: #fff;padding-bottom: 250px;">
        ...
        <td><img src="{{url('images').'/email/rejected.png'}}" width="30%" style="
              ...
              <center>     
                ...
                <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                  ...
                  <tr>
                      ...
                      <p>Your appointment has been cancelled. Please check below for details.</p>
                        ...
                        <center>
                          ...
                          <table style="width: 100%;text-align: justify;margin-top: 30px;">
                              ...
                              <tr>
                                  ...
                                  <td style="border-bottom:1px solid #ddd;padding: 10px;border-collapse: collapse;line-height: 1.5;font-size: 13px;width:50%;">Client name</td>

                                  <td style="border-bottom:1px solid #ddd;padding: 10px;border-collapse: collapse;line-height: 1.5;font-size: 13px;width:50%;">{{ ucfirst($appInfo->requester_name) }}</td>
                              ...
                              <tr>
                                  ...
                                  <td style="border-bottom:1px solid #ddd;padding: 10px;border-collapse: collapse;line-height: 1.5;font-size: 13px;width:50%;">Refund Id</td>                                   

                                  <td style="border-bottom:1px solid #ddd;padding: 10px;border-collapse: collapse;line-height: 1.5;font-size: 13px;width:50%;">{{$refund_id}}</td>
                              ...
                              <tr>
                                  ...
                                  <td style="border-bottom:1px solid #ddd;padding: 10px;border-collapse: collapse;line-height: 1.5;font-size: 13px;width:50%;">{{conversion_to_pound($refund_amount)}}</td>
