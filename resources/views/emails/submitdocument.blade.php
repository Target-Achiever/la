                        ...
                        <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <h4>Hi <span style="color:#00d4ff;">{{ ucfirst($user[0]['name']) }}</span>,
                                        <br><br></h4>
                                    <p>Thank you for submiting your details and documents. Your submitted documents are currently being verified and you will receive an email update from us shortly. </p>
