...
@section('content')
        <table cellspacing="0" cellpadding="0" class="force-full-width" style="border:1px solid #ddd;">
            <tr style="background-color: #fff;padding-bottom: 250px;">
                <td><img src="{{ URL::asset('images/Admin_Deactive.png')}}" style="    padding-top: 50px;" width="30%">
                </td>
            </tr>
            <tr>
                        ...
                        <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                            <tr>
                                <td style="text-align: center;"><h4>Hi <span style="color:#00d4ff;">{{ ucfirst($user[0]['name']) }}</span>,
                                        <br><br> </h4>
                                    <p>Your linkaesthetics account has been deactivated by admin due to some issues.
                                        <br>Kindly contact us for more information.</p>
