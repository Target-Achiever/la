...
<!--/#main-slider-->
        ...
        <div class="aboutus">
            <div class="container">
                <h3>{{isset($blog_list[\Route::input('blog')]['title']) ?  $blog_list[\Route::input('blog')]['title'] : 'Title'}}</h3>
                ...
                @if($blog_type == 'EyeTrend')
                    ...
                    <p>Reshape, redefine and re-contour your body non-surgically with little down time. For more information or to book a consultation, get in touch today to find out how we can help you. 
                    </p>
                ...
                <div class="col-sm-3 col-md-3 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms"">
                    <div class="more-service-side">
                        ...
                        <div class="list-group">
                            <!-- blog list -->
                            @foreach ($blog_list as $type => $blog)
                                <a href="{{$blog['url']}}" class="list-group-item {{$type == \Route::input('blog') ? 'active' : ''}}">
                                    <i class="fa fa-arrow-right"></i> {{ $blog['title']}}
                                </a>
                            @endforeach
                        </div>
                    </div>    
