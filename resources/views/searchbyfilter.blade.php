        ...
        <div class="container-fluid search">
            <section class="search_content">
                <!-- <form class="form-inline" role="form"> -->
                    search by filter
                {!! Form::open(['url' => 'search/','class' => 'form-inline','id' => 'search-services-form']) !!}
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">   
                            <div class="form-group">                                               
                                ...
                                <input type="text" class="form-control" id="providers-list-input" list="providers-list" placeholder="Search doctors,clinics,hospitals,etc">
                                <datalist id="providers-list">                                                           
                                </datalist>
                                <!-- <select id="providers-list">
                                                    ...
                                                    <div class="list_content">
                                                        ...
                                                        <div class="col-md-7 col-sm-7">
                                                            <div class="list_btn_cols">
                                                                @foreach($provider['providers_services'] as $services)
                                                                <button class="btn btn-primary">{{$services->service}}</button><span class="price">€{{$services->service_amount}}</span>
                                                                @endforeach
