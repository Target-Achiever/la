        ...
        <tr>
          ...
          <table style="margin:0 auto;" cellspacing="0" cellpadding="0" width="100%">
            <tr>
              <td style="background-color: transparent;">
                ...
                <a href="#"><img class="w320" src="{{url('images').'/logo.png'}}" style="max-height:70px;padding-bottom: 10px;" alt="logo" /></a>
              </td>
            </tr>
          </table>          
          ...
          <table cellspacing="0" cellpadding="0" class="force-full-width" style="border:1px solid #ddd;">
			<tr style="background-color: #fff;padding-bottom: 250px;">
				<td><img src="{{url('images').'/email/forgot-password.png'}}" style="
    padding-top: 50px;
"></td>
			</tr>
            <tr>
                ...
                <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                  <tr>
                    <td style="text-align: center;">                    
                      <h4>Hi,<br><br></h4>       
                      <p style="line-height: 1.5;font-size:15px;">Click here to reset your password: <a href="{{ $link = url('password/reset', $token).'?email='.urlencode($user->getEmailForPasswordReset()) }}"> Reset </a></p>
                    </td>
                  </tr>
                </table>
              </center>
              ...
              <table cellspacing="0" cellpadding="0" bgcolor="#fff"  class="force-full-width">
                <tr>
