...
define('SP_WEBPATH', 'http://www.linkaesthetics.com/statistics');

# DB settings - You can get this info from your web hosting provider.
# The name of the database for seo panel
define('DB_NAME', 'i4672636_sp2');

# DB database username
define('DB_USER', 'i4672636_sp2');

# DB database password
define('DB_PASSWORD', 'S.VW5u436YFX7xR9h8i36');
